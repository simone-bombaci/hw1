...
/*function removecuore(event)
{
  const a = event.currentTarget;
  a.src = 'cuorevuoto.png';
  a.removeEventListener('click', removecuore);

  a.addEventListener('click', metticuore);
}*/




fetch("api_science.php").then(OnResponse).then(OnJson);
